...
# PointList - A list of points (either 2d or 3d)
#   Serves as the basis for ControlHull and PointListWithTs
# PointListWithTs - assign t values to each point
#   - monotonically increasing from 0 to 1
#   - Initially set by length of segments
#
# Both classes support
#  - adding a new point
#  - converting the points to a numpy array of size dim() X number of points
#
class PointList:
